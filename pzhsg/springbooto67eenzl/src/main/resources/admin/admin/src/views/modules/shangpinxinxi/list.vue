		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"border":"1px solid #bababa","padding":"20px","margin":"0px","overflow":"hidden","borderRadius":"8px","background":"#fff","fontSize":"inherit"}' :inline="true" :model="searchForm">
				<el-row :style='{"width":"100%","padding":"10px","fontSize":"inherit","textAlign":"center","background":"#fff","display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">水果名称</label>
						<el-input v-model="searchForm.shangpinmingcheng" placeholder="水果名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"inline-block"}' class="select" label="水果类型" prop="shangpinleixing">
						...
						<el-select clearable v-model="searchForm.shangpinleixing" placeholder="请选择水果类型" >
			...
			<div :style='{"border":"1px solid #bababa","width":"100%","padding":"0","margin":"30px 0 0","borderRadius":"8px","background":"rgba(255,255,255,.9)"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<!-- 无 -->
					<el-table-column :resizable='true' :sortable='true' prop="shangpintupian" width="200" label="水果图片">
						<template slot-scope="scope">
