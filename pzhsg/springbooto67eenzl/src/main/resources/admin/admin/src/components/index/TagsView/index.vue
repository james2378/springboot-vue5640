<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0","boxShadow":"0px 0px 0px #ccc","margin":"0","borderColor":"#bababa","overflow":"hidden","background":"none","borderWidth":"1px 0","width":"calc(100% - 0px)","fontSize":"15px","borderStyle":"solid","height":"auto"}'>
